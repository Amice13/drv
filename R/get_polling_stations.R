...
get_polling_stations <- function(ps) {
  ...
  #' }
  #'
  #' @param ps a district number from \strong{Area_Num} in \strong{get_districts}
  #' @export
  ...
  vectors_list <- lapply(vectors_list, function (x) { unlist(x) })
